...
volatile unsigned char WIFI[] = "AT+CWJAP=\"Buckeye\", \"Debarr58\"\r\n"; // Connects to local internet connection
...
volatile unsigned char SEND_DATA[] = "GET /update?key=0D46YJRKCJ7XZ3AV&field1="; // Write API key
